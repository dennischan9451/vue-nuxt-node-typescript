        ...
        try {
            ...
            for (let i = 0; i < _notice_list.length; i++) {
                ...
                if ((req.decodedUser.user_type == global.ROLE.indexOf("company") + 1)
                    ...
                    if (_item.notice.type == 1 || _item.notice.type == 3 || _item.notice.type == 4) {
                        table_item = {
                    ...
                    if (_item.notice.type == 1 || _item.notice.type == 10 || _item.notice.type == 11) {
                        table_item = {
                    ...
                    if (_item.notice.type == 1 || _item.notice.type == 12 || _item.notice.type == 13) {
                        table_item = {
                            id: _item.notice.request.id,
                            end_date: _item.create_date,
                            title: _item.notice.request.request.title,
