...
class DashboardController {
    ...
    static getRequestStatus = async(req: Request, res: Response) => {
        ...
        try {
            if(global.ROLE[req.decodedUser.user_type-1] == 'requester' || global.ROLE[req.decodedUser.user_type-1] == 'company' || global.ROLE[req.decodedUser.user_type-1] == 'admin' || global.ROLE[req.decodedUser.user_type-1] == 'manager') {
