        ...
        try {
            ...
            if(search.billing_type == 1 || search.billing_type == 2 || search.billing_type == 3) {
                ...
                sub_query = sub_query.addSelect('"trans_request"."currency_type"')
                            ...
                            .addSelect('sum(trans_request.tc_work_price) / count(trans_request.id)', 'tc_work_price')
                            .addSelect('sum(request_detail.translate_work_price)', 'translate_work_price')
                            .addSelect('sum(request_detail.review_work_price)', 'review_work_price')
                            .addSelect('sum(trans_request.tc_work_price) / count(trans_request.id) + \
                            sum(request_detail.translate_work_price) + \
                            sum(request_detail.review_work_price)', 'total_work_price')
                            .from(TransRequest, "trans_request")
                ...
                sub_query = getConnection()
                            ...
                            .addSelect('"trans_request"."tc_work_price"', 'tc_work_price')
                ...
                sub_query = getConnection()
                            ...
                            .addSelect('"trans_request"."duration"', 'duration')
                            .addSelect('"request_detail_worker"."price"', 'work_price')
