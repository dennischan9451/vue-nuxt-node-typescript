    ...
    <el-row :gutter="15" class="bottom-list-items">
      <el-col v-loading="compLoading" :md="24" :lg="12" class="ongoing-trans-board">
        ...
        <board-company-card
          ...
          :route-name="'caption-list-admin'"
          :route-params="{ dateType: 2, startDate: getStartDate(), endDate: getEndDate(), company: item.user_no }"
        />
      </el-col>
      <el-col v-loading="reqLoading" :md="24" :lg="12" class="finished-trans-board">
        ...
        <board-requester-card
          ...
          :route-name="'caption-list-admin'"
          :route-params="{ dateType: 2, startDate: getStartDate(), endDate: getEndDate(), requester: item.user_no, company: item.company_no }"
        />
      </el-col>
    </el-row>
  </div>
